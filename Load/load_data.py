...
class DataRetriever:
    ...
    Attributes:
        url (str): The URL from which the data will be loaded.
        DATASETS_DIR (str): The path to the directory where the data will be saved.
    ...
    def retrieve_data(self):
        ...
        data.to_csv(os.path.join(self.DATASETS_DIR, self.RETRIEVED_DATA), index=False)

        return f'Data stored in {os.path.join(self.DATASETS_DIR, self.RETRIEVED_DATA)}'
